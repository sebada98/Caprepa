...
-- Tiempo de generación: 03-05-2023 a las 00:53:30
...
(2, 'Sinaí', 'Ortega', 'lizforevah@gmail.com', '6674733067'),
(3, 'Sebastián', 'Gutiérrez Gavia', 'sebastian.gutierrez.gavia3136@gmail.com', '6671524511');
...
CREATE TABLE IF NOT EXISTS `montos` (
  ...
  `tasa_interes` decimal(5,2) DEFAULT '0.15',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
